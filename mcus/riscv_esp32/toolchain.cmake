...
ENDIF()
##
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${PPATH} ${IDF_CPN_EXTRA} ${CUSTOM_TARGET_FLAGS}" CACHE INTERNAL "")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${PPATH} ${IDF_CPN_EXTRA} ${CUSTOM_TARGET_FLAGS}" CACHE INTERNAL "")
