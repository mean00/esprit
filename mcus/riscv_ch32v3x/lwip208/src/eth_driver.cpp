...
void ETH_SetClock(void)
{
   ...
   #warning TODO Setup DIVIER for 60Mhz EthClk / PLL3
}
...
void ETH_Configuration( uint8_t *macAddr )
{
    ...
    R8_ETH_ECON2 &= ~(0x07 << 1);
    R8_ETH_ECON2 |= 5 << 1;
#warning TODO enable ETH10M clock + ENable

    //1EXTEN->EXTEN_CTR |= EXTEN_ETH_10M_EN;
}
...
void ETH_Init( uint8_t *macAddr )
{
  ...
  #warning todo enable ethernet IRQ
}
